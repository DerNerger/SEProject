...
public class AreaInformationDialog extends DialogFragment {
	...
	public static AreaInformationDialog newInstance(int area,Species species,int pnumber){
	...
	public View onCreateView(LayoutInflater inflater,ViewGroup container,Bundle savedInstanceState){
		...
		//to the bottom of the screen
		 ...
		 params.x = 0;
		 params.y = getResources().getDimensionPixelSize(R.dimen.area_information_height);
	...
	private void setViews(View root){
		tview=(TemperatureView) root.findViewById(R.id.temperature_view_area_information);
		resources=(TextView) root.findViewById(R.id.text_view_area_information_ressources);
		enemies=(TextView) root.findViewById(R.id.text_view_area_information_enemies);
		fieldtype=(TextView) root.findViewById(R.id.text_view_area_information_fieldtype);
		population=(TextView) root.findViewById(R.id.text_view_area_information_population);
	}
	public void update(){
	...
	private void setFieldtype(FieldType type){
		switch(type){
		case DESERT:fieldtype.setText(R.string.desert); break;
		case ICE: fieldtype.setText(R.string.ice); break;
		case JUNGLE: fieldtype.setText(R.string.jungle); break;
		case LAND: fieldtype.setText(R.string.land); break;
		case WATER: fieldtype.setText(R.string.water); break;
		default: throw new RuntimeException("Fieldtype nicht verfügbar");
		}
	}
